...
var KTAppInbox = function() {
    ...
    var _initForm = function(formEl) {
        ...
        var tagifyTo = new Tagify(toEl, {
            ...
            whitelist: [{
                value: 'prompt.mortgage@gmail.com',
                email: 'Prompt Mortgage',
                initials: '',
                initialsState: '',
            ...
            {
                value: 'chirag@houstonsupport.com',
                email: 'Chirag Dhruve',
                initials: '',
                initialsState: '',
                pic: './assets/media/users/100_11.jpg',
            ...
            {
                value: 'bimal@houstonsupport.com',
                email: 'Bimal Shukla',
                initials: '',
                initialsState: '',
                pic: './assets/media/users/100_11.jpg',
            ...
            templates: {
                dropdownItem: function(tagData) {
                    try {
                        ...
                        html += '       <span class="symbol symbol-' + (tagData.initialsState ? tagData.initialsState : '') + ' mr-2">';
    ...
    return {
        ...
        initRefreshView: function() {
            // Back to listing
            KTUtil.on(_listEl, '[data-inbox="refresh"]', 'click', function() {
                // demo loading
                var loading = new KTDialog({
                    'type': 'loader',
                    'placement': 'top center',
